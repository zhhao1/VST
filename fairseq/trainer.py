...
class Trainer(object):
    ...
    def train_step(self, samples, raise_oom=False):
        ...
        for i, sample in enumerate(samples):  # delayed update loop, len(samples) = update-freq
            #logging.info(len(samples))
            #logging.info(sample['target'].size())
            #logging.info(sample['net_input']['src_tokens'].size())
