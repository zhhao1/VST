...
def get_training_parser(default_task="translation"):
    parser = get_parser("Trainer", default_task)  #parser.actions parser.print_help()
...
def get_parser(desc, default_task="translation"):
    ...
    parser = argparse.ArgumentParser(allow_abbrev=False) #allow_abbrev:允许长选项的缩写，如参数为footbar,传递foot也可以被识别
