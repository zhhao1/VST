...
class SpeechToTextTask(LegacyFairseqTask):
    ...
    def add_args(cls, parser):
        ...
        parser.add_argument("--word-droprate", type=float, default=0.3)
        parser.add_argument("--pretrain-utt", action="store_true")
        parser.add_argument(
            "--config-yaml",
            type=str,
            default="config.yaml",
    ...
    def __init__(self, args, tgt_dict):
        ...
        self.data_cfg.word_dropout = getattr(args, "word_dropout", False)
        self.data_cfg.word_droprate = getattr(args, "word_droprate", 0.3)
        self.data_cfg.pretrain_utt = getattr(args, "pretrain_utt", False)
